...
################################################################################
## Form generated from reading UI file 'ui_mainCuoANn.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        if MainWindow.objectName():
            MainWindow.setObjectName(u"STEGANO")
        MainWindow.resize(880, 600)
        MainWindow.setWindowIcon(QIcon('.img\\mona-l.jpg')) 
        # set the title 
...
"}")
        ...
        self.pushButton_2 = QPushButton(self.frame_circle_2)
...
"font: 20pt \"MS Shell Dlg 2\";")
        ...
        self.frame_circle_3.setAutoFillBackground(False)
...
"}")
        ...
        self.verticalLayout_8.setContentsMargins(5, 5, 3, 5)
        self.pushButton_3 = QPushButton(self.frame_circle_3)
...
"font:14px;")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"STEGANOREX-ENCODER", None))
        self.label_title2.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;STEGANOREX-Encode</p></body></html>", None))
        ...
        self.pushButton_2.setText(QCoreApplication.translate("MainWindow", u"Hidden Image", None))
